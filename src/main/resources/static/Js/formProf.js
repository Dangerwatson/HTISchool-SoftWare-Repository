$(document).ready(function(){
    //var firstName = document.getElementById("firstName"),
               var lastName = document.getElementById("nomP");
               prenom = document.getElementById("prenomP"),
               phone = document.getElementById("telephoneProf"),
               sal = document.getElementById("salaireProf"),
               lieu = document.getElementById("lieuN"),
