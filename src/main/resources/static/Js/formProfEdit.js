$(document).ready(function(){
               ...
               var  nomEdi = document.getElementById("nomEdit");
               prenomEdi = document.getElementById("prenomEdit"),
               lieuNEdi = document.getElementById("lieuNEdit"),
               emailProfEdi = document.getElementById("emailProfEdit"),
               salaireProfEdi = document.getElementById("salaireProfEdit"),
